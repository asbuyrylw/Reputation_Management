  ...
  return (
    <span className="relative inline-block">
      <button
        ...
        className="cursor-help border-b border-dotted border-gray-400 text-left"
      ...
      {open && (
        <span
          role="tooltip"
          className="absolute bottom-full left-0 z-20 mb-1 w-64 rounded-lg border border-gray-200 bg-white p-3 text-left text-xs font-normal shadow-lg"
        >
          <span className="block font-semibold text-gray-900">{name}</span>
          <span className="mt-1 block text-gray-700">{entry.plain}</span>
