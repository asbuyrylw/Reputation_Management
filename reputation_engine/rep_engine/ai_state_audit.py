...
SCORING_SYSTEM = (
    ...
    "Two calibrations to get right: "
    "(a) an answer that simply has NO information about the business, does not recognize it, or gives a generic "
    "non-answer is an AWARENESS gap -- the AI has never heard of this business. For an AI-REPUTATION goal that "
    "is MILDLY UNFAVORABLE (the business is invisible where it needs to be surfaced), NOT neutral: score it "
    "about -0.3 (range -0.45..-0.15). It is still fundamentally different from a NEGATIVE answer -- do NOT score "
    "it below -0.5, and set awareness=FALSE so it is tracked as a void to FILL rather than a hostile narrative. "
    "Only go below -0.5 when the answer actually expresses doubt, caution, red flags, or scam/fraud framing about "
    "THIS specific business -- never merely for lacking information about it; "
